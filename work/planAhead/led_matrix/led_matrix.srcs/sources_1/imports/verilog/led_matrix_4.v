...
module led_matrix_4 (
  ...
  always @* begin
    ...
    out_clk = M_shift_reg_clk_q[5+0-:1];
    ...
    if (1'h1 <= M_register_input_counter_q && M_register_input_counter_q < 7'h7f) begin
      ...
      if (M_register_input_counter_q == 7'h7e) begin
        out_lat = 1'h1;
